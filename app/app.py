...
def main() -> None:
    ...
    if last_message.get("role") == "user":
        ...
        with st.chat_message("assistant"):
            ...
            response = ""
            for delta in lyraios.run(question):
    ...
    if lyraios.knowledge_base and lyraios.knowledge_base.vector_db:
    ...
    if lyraios.storage:
        ...
        if st.session_state["lyraios_run_id"] != new_assistant_run_id:
